...
public class MeleeDamage implements Upgrade {

	private final ItemStack icon = new ItemStack(Material.INK_SACK, 1, (short) 1);
	private final ArrayList<String> description = new ArrayList<>();

	public MeleeDamage() {
		description.add("&7Each tier:");
		description.add("&7Deal &c+1% &7melee damage.");
	}
